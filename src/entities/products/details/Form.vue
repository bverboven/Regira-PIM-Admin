              ...
              <div class="row">
                ...
                <div class="col-lg mb-2">
                  <UnitTypeInputSelector
                    ...
                    v-model:id-value="item.unitTypeId"
                    :readonly="readonly"
                  />
...
import {
  InputSelectorInline as SupplierInputSelectorInline,
  InputSelectorOverview as SupplierInputSelectorOverview,
} from "@/entities/products/product-suppliers/";
